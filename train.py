...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='yolov5s.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/aicar.yaml', help='dataset.yaml path')
